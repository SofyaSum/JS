document.addEventListener('DOMContentLoaded', () => {
    ...
    var FIGURES = [
        ...
        {
            cells: [0, 1, BOARDWIDTH, BOARDWIDTH+1, BOARDWIDTH*2+1],
            width: 4,
            color: 'qFigure',
        }
    ]
    ...
    function gameOver() {
        alert('Вы проиграли!');
        boardElement.style.borderColor = 'crimson';
        gameFinished = true;
    }
    ...
    function pauseHandler() {
        if (gamePaused) {
            ...
            boardElement.style.borderColor = 'springgreen';
    ...
    function setNewFigure() {
        gameBoard.currentFigureNumber = nextFigureNumber;
        ...
        gameBoard.nextPosition = gameBoard.currentPosition;
        gameBoard.next = FIGURES[gameBoard.currentFigureNumber];
        nextFigureNumber = Math.floor(Math.random()*FIGURES.length);
        nextElement.innerHTML = 'Следующий: <img src="img/'+FIGURES[nextFigureNumber].color+'.png">';
